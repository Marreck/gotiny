...
func TestGetName(t *testing.T) {
	...
	items := []struct {
		...
		{"int", int(1)},
		{"github.com/Marreck/gotiny.Encoder", gotiny.Encoder{}},
		{"*int", (*int)(nil)},
		{"**int", (**int)(nil)},
		{"[]int", []int{}},
		{"[]time.Time", []time.Time{}},
		{"[]github.com/Marreck/gotiny.GoTinySerializer", []gotiny.GoTinySerializer{}},
		{"*interface {}", (*interface{})(nil)},
		{"map[int]string", map[int]string{}},
		{"struct { a struct { int; b int; dec []github.com/Marreck/gotiny.Decoder; abb interface {}; c io.ReadWriteCloser } }",
			struct {
				a struct {
					int
					b   int
